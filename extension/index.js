...
var themeStylePaths = {
	'Dark ITheme': '../themes/Dark ITheme.css',
	'Dark ITheme (Sidebar)': '../themes/Dark ITheme (Sidebar).css',
	'Light ITheme': '../themes/Light ITheme.css',
	'Light ITheme (Sidebar)': '../themes/Light ITheme (Sidebar).css',
}

const themeConfigPaths = {
	'Dark ITheme': '../themes/Dark ITheme.json',
	'Dark ITheme (Sidebar)': '../themes/Dark ITheme (Sidebar).json',
	'Light ITheme': '../themes/Light ITheme.json',
	'Light ITheme (Sidebar)': '../themes/Light ITheme (Sidebar).json',
}

var defaultTheme = 'Dark ITheme (Sidebar)';
